...
const TransactionProgressDetails: React.FC = () => (
  <div className="glass-card rounded-2xl p-8 w-full min-h-[300px] bg-white/80 backdrop-blur-xl border border-pink-100/30 shadow-lg relative overflow-hidden group">
    ...
    <div className="text-2xl font-black text-slate-900 mb-6 tracking-tight uppercase">Transaction Progress Details</div>
    ...
    <div className="flex flex-col items-center justify-center w-full mt-8 relative z-10">
      ...
      <span className="text-slate-900 text-lg font-black uppercase tracking-widest text-center">Start a call to track progress</span>
      <span className="text-slate-400 text-sm font-black uppercase tracking-[0.2em] text-center mt-3 opacity-60 italic">Real-time success probability engine will activate upon connection</span>
    </div>
  </div>
);
