...
const CONFETTI_COLORS = ['#fbbf24', '#f43f5e', '#6366f1', '#10b981', '#facc15', '#a855f7'];
...
<body>
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-[#0b1025]/95 backdrop-blur-md overflow-y-auto p-4 py-12">
      ...
      <div
        className={`relative z-[2] max-w-4xl w-full bg-white/5 border border-white/10 rounded-[40px] shadow-2xl overflow-hidden transition-all duration-1000 transform ${
      ...
      >
        ...
        <div className="p-8 md:p-12 text-center relative">
          ...
          <div className="relative inline-block mb-8 group">
            ...
            <div className="relative w-48 h-48 md:w-56 md:h-56 flex items-center justify-center">
              ...
              <div className="cert-ring absolute inset-0 rounded-full border-2 border-dashed border-yellow-400/40"></div>
              <div className="w-[88%] h-[88%] rounded-full bg-gradient-to-tr from-amber-200 via-yellow-400 to-amber-600 p-1 shadow-2xl transform group-hover:scale-105 transition-transform duration-700">
              ...
              {/* Floating Stars */}
              <Star className="absolute top-4 right-4 w-6 h-6 text-yellow-400 fill-yellow-400 animate-bounce" style={{ animationDuration: '3s' }} />
              <Star className="absolute bottom-10 -left-2 w-4 h-4 text-yellow-400 fill-yellow-400 animate-bounce" style={{ animationDuration: '2.5s' }} />
              <Sparkles className="absolute top-1/2 -right-6 w-5 h-5 text-yellow-400 animate-pulse" />
            </div>
          </div>
          ...
          <div className="space-y-4 mb-10">
            ...
            <h1 className="text-4xl md:text-6xl font-black text-white leading-tight">
              Félicitations, <br />
              <span className="cert-shimmer text-transparent bg-clip-text bg-gradient-to-r from-amber-200 via-yellow-400 to-amber-600">
                {traineeName}
              </span>
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 max-w-3xl mx-auto">
            <div className="p-6 rounded-3xl bg-white/5 border border-white/10 flex flex-col items-center gap-2 hover:bg-white/[0.07] transition-colors">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button
              ...
              className="w-full sm:w-auto px-10 py-5 rounded-2xl bg-gradient-to-r from-harx-600 to-harx-alt-500 text-white font-bold text-lg shadow-lg hover:shadow-harx-500/30 hover:-translate-y-1 transition-all duration-300 flex items-center justify-center gap-3"
            >
        ...
        <div className="bg-white/5 border-t border-white/10 p-6 text-center">
          <p className="text-slate-500 text-sm">
            Certifié par <span className="text-slate-300 font-bold">HARX Academy</span> • ID: {certId}
          </p>
        </div>
      </div>
    </div>
